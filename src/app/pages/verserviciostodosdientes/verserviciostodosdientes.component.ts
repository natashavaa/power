...
@Component({
  selector: 'app-verserviciostodosdientes',
  templateUrl: './verserviciostodosdientes.component.html',
  styleUrls: ['./verserviciostodosdientes.component.css']
})
export class VerserviciostodosdientesComponent implements OnInit {
...
public ortodoncia: OrtodonciaInterface = {};
...
this.ortodoncia = this.auth.getortodoncia();
this.seguimientosrecibidos = this.auth.getTodoslosDientes();
}
getlistAllServicios() {
