...
@Component({
  selector: 'app-verservicios-ortodoncia',
  templateUrl: './verservicios-ortodoncia.component.html',
  styleUrls: ['./verservicios-ortodoncia.component.css']
})
export class VerserviciosOrtodonciaComponent implements OnInit {
